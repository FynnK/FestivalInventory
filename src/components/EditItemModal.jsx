        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-background border border-input rounded-lg px-3 py-2 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              placeholder="e.g. Hardware, Cables, Consumables..."
              list="category-list"
            />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                onChange={e => setForm({ ...form, minStockThreshold: parseInt(e.target.value) || 0 })}
                className="w-full bg-background border border-input rounded-lg px-3 py-2 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={e => setForm({ ...form, unitQuantity: parseInt(e.target.value) || 1 })}
                className="w-full bg-background border border-input rounded-lg px-3 py-2 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              />
            </div>
            <div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              onClick={handleSave}
              className="flex-1 px-4 py-2.5 rounded-lg bg-primary text-primary-foreground font-semibold hover:opacity-90 transition-opacity text-sm"
            >
